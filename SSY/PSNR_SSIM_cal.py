...
import numpy as np
import math
from utils.utils_general import bgr2ycbcr
from skimage.metrics import structural_similarity as ssim


def cal_SSIM2(img1, img2):
    #SSY
    return ssim(img1, img2)

def cal_PSNR2(img_HR, img_SR, use_YCbCr = False):
    #SSY from https://github.com/ayu255/CMDSR/blob/main/PSNR_SSIM_cal.py
    #x3
...
def cal_PSNR(img_HR, img_SR, use_YCbCr = True):
    #https://github.com/ayu255/CMDSR/blob/main/PSNR_SSIM_cal.py
    #x3
    # if img_SR.shape[1] != img_HR.shape[1] or img_SR.shape[0] != img_HR.shape[0]:
        # img_HR = cv2.resize(img_HR,(img_SR.shape[1], img_SR.shape[0]), interpolation=cv2.INTER_CUBIC)
    # crop borders
