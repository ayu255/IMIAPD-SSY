...
def anisotropic_Gaussian(ksize=15, theta=np.pi, l1=6, l2=6):
    ...
    Returns:
        k     : kernel
    """
    ## 如果特征值的缩放因子 l1,l2相同，那就是一个各向同性的高斯核
...
def gm_blur_kernel(mean, cov, size=15):
    #正在生成高斯核的函数
    #如果 cov 是对角矩阵，并且对角线上的元素相等，那么生成的将是各向同性的高斯核。如果 cov 不是对角矩阵，或者对角线上的元素不等，那么生成的将是各向异性的高斯核。
    center = size / 2.0 + 0.5
...
if __name__ == "__main__":
    ...
    img_array = Gaussian_blur(img_array, k = anisotropic_Gaussian(),sf=4)
